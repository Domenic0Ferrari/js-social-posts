...
// Dobbiamo manipolare un array di oggetti
// Selezionare nel DOM gli elementi su cui iterare
let eleContainer = document.querySelector('#container');

// Creo una variabile vuota dove inserire i post
let post = '';

// Necessito di un ciclo per prendere gli elementi dall'array ed inserirli nella variabile 'post'
        ...
        <div class="post">
            <div class="post__header">
                <div class="post-meta">
                    <div class="post-meta__icon">
                        <img class="profile-pic" src="${element.author.image}" alt="social image">
                    </div>
            ...
            <div class="post__text">${element.content}</div>
                <div class="post__image">
                    <img src="${element.media}" alt="landscape" />
                </div>
